...
| All other first-professionals | 89 | 86 | 0 | 0 |
...
B6. Final 1998 cohort, after adjusting for allowable exclusions: 1465
(Subtract question B5 from question B4)
...
If necessary, use this space to clarify your test policies (e.g., if tests are recommended for some students, or if tests are not required of some students): Freshmen applicants age 21 or over are not required to submit ACT or SAT scores.
...
G4. If tuition and fees vary by undergraduate instructional program, describe briefly: Some programs have additional costs. Contact the Admissions Office for more information.
# Common Data Set 2004-05 
...
|  | $\$$ | $\$$ |
| Scholarships/Grants |  |  |
| Federal | $\mathbf{9 , 4 6 8 , 6 8 1}$ | $\mathbf{4 1 5 , 3 7 6}$ |
| State (i.e., all states, not only the state in <br> which your institution is located) | $\mathbf{8 , 6 8 2 , 8 6 5}$ | $\mathbf{8 0 5 , 7 6 0}$ |
| Institutional (endowment, alumni, or <br> other institutional awards) and external <br> funds awarded by the college excluding <br> athletic aid and tuition waivers (which are <br> reported below) | $\mathbf{6 8 , 1 2 5}$ | $\mathbf{3 , 7 8 6 , 2 6 1}$ |
| Scholarships/grants from external sources <br> (e.g., Kiwanis, National Merit) not <br> awarded by the college | $\mathbf{8 6 , 3 9 4}$ | $\mathbf{1 , 2 9 3 , 2 1 7}$ |
| Total Scholarships/Grants | $\mathbf{1 8 , 3 0 6 , 0 6 6}$ | $\mathbf{6 , 3 0 0 , 6 1 5}$ |
| Self-Help | $\mathbf{1 8 , 3 2 8 , 0 7 0}$ | $\mathbf{8 , 7 0 8 , 9 2 4}$ |
| Student loans from all sources (excluding <br> parent loans) |  |  |
| Federal Work-Study | $\mathbf{2 , 0 0 9 , 6 6 3}$ | $\mathbf{3 7 6 , 9 0 3}$ |
| State and other (e.g., institutional) work- <br> study/employment (Note: Excludes <br> Federal Work-Study captured above.) | $\mathbf{2 0 , 3 3 7 , 7 3 3}$ | $\mathbf{9 , 0 8 5 , 8 2 8}$ |
| Total Self-Help | $\mathbf{2 0 , 3 3 7 , 7 3 3}$ | $\mathbf{2 , 7 2 6 , 5 6 8}$ |
| Parent Loans | $\mathbf{7 , 0 3 5 , 2 5 5}$ |  |
| Tuition Waivers <br> Note: Reporting is optional. Report tuition <br> waivers in this row if you choose to report <br> them. Do not report tuition waivers <br> elsewhere. | $\mathbf{1 , 7 6 0 , 4 8 8}$ |  |
| Athletic Awards |  |
H2. Number of Enrolled Students Awarded Aid: List the number of degree-seeking full-time and less-than-full-time undergraduates who applied for and were awarded financial aid from any source. Aid that is non-need-based but that was used to meet need should be counted as need-based aid. Numbers should reflect the cohort awarded the dollars reported in H1. Note: In the chart below, students may be counted in more than one row, and full-time freshmen should also be counted as full-time undergraduates.

|  |  | First-time Full-time Freshmen | Full-time Undergrad (Incl. Fresh) | Less Than Full-time Undergrad |
| :--: | :--: | :--: | :--: | :--: |
| a) | Number of degree-seeking undergraduate students (CDS Item B1 if reporting on Fall 2004 cohort) | 1483 | 7935 | 1420 |
| b) | Number of students in line $\mathbf{a}$ who applied for need-based financial aid | 1140 | 5614 | 834 |
| c) | Number of students in line $\mathbf{b}$ who were determined to have financial need | 837 | 3975 | 650 |
| d) | Number of students in line $\mathbf{c}$ who were awarded any financial aid | 820 | 3870 | 615 |
| e) | Number of students in line $\mathbf{d}$ who were awarded any need-based scholarship or grant aid | 737 | 2870 | 377 |
| f) | Number of students in line $\mathbf{d}$ who were awarded any need-based self-help aid | 463 | 2735 | 505 |
| g) | Number of students in line $\mathbf{d}$ who were awarded any non-need-based scholarship or grant aid | 265 | 1094 | 52 |
| h) | Number of students in line $\mathbf{d}$ whose need was fully met (exclude PLUS loans, unsubsidized loans, and private alternative loans) | 285 | 1880 | 277 |
| i) | On average, the percentage of need that was met of students who were awarded any need-based aid. Exclude any aid that was awarded in excess of need as well as any resources that were awarded to replace EFC (PLUS loans, unsubsidized loans, and private alternative loans) | $80 \%$ | $79 \%$ | $79 \%$ |
| j) | The average financial aid package of those in line d. Exclude any resources that were awarded to replace EFC (PLUS loans, unsubsidized loans, and private alternative loans) | \$6847 | \$4662 | \$5579 |
| k) | Average need-based scholarship or grant award of those in line $\mathbf{e}$ | \$4090 | \$2782 | \$2987 |
| 1) | Average need-based self-help award (excluding PLUS loans, unsubsidized loans, and private alternative loans) of those in line $\mathbf{f}$ | \$1506 | \$3126 | \$4338 |
| m) | Average need-based loan (excluding PLUS loans, unsubsidized loans, and private alternative loans) of those in line $\mathbf{f}$ who were awarded a needbased loan | \$1085 | \$3602 | \$4161 |
...
| 1.) | Total number in stand-alone graduate/ professional programs in which faculty, teach virtually only graduate-level students |  |  |  |
