...
|  | All First-Year | All <br> Undergraduates |
| :--: | :--: | :--: |
|  | IPEDS sum of lines 1, 2, $15, \& 16$ | IPEDS sum of lines $8 \& 22$ |
| Non-resident aliens IPEDS cols. 1-2 | 98 | 777 |
| Black, non-Hispanic IPEDS cols. 3-4 | 256 | 899 |
| American Indian or Alaskan Native IPEDS cols. 5-6 | 23 | 140 |
| Asian or Pacific <br> Islander <br> IPEDS cols. 7-8 | 1748 | 7996 |
| Hispanic IPEDS cols. 9-10 | 695 | 3113 |
| White, non-Hispanic IPEDS cols. 11-12 | 814 | 5366 |
| Race/ethnicity unknown IPEDS cols. 13-14 | 431 | 2441 |
| Total IPEDS cols. 15-16 | 4065 | 20732 |
...
B4. Initial 1992 cohort of first-time, full-time bachelor's (or equivalent) degree-seeking undergraduate students; total all students: 1420
...
B6. Final 1992 cohort, after adjusting for allowable exclusions: 1420
(Subtract question B5 from question B4)
B7. Of the initial 1992 initial cohort, how many completed the program in four years or less (by August 31, 1997): 51 (IPEDS GRS, Section II, Part A, line 19, sum of columns 15 and 16)
B8. Of the initial 1992 cohort, how may completed the program in more than four years but in five years or less (after August 31, 1996 and by August 31, 1997): 278 (IPEDS GRS, Section II, Part A, line 20, sum of columns 15 and 16)
B9. Of the initial 1992 cohort, how many completed the program in more than five years but in six years or less (after August 31, 1997 and by August 31, 1998): 218 (IPEDS GRS, Section II, Part A, line 21, sum of columns 15 and 16)
...
B11. Six-year graduation rate for 1992 cohort (question B10
divided by question B6): 38.5
...
Total men applied: 4312
Total women applied: 4568
Total men admitted: 3234
Total women admitted: 3464
Total full-time, first-time, first-year (freshman) men enrolled: 1006
Total part-time, first-time, first-year (freshman) men enrolled: 72
Total full-time, first-time, first-year (freshman) women enrolled: 957
Total part-time, first-time, first-year (freshman) women enrolled: 61
...
other (explain):
delete: C7. Relative importance of each of the following academic and nonacademic factors in your first-time, first- year, degree-seeking (freshman) admission decisions.
...
| Percent submitting SAT scores: 86\% <br> Percent submitting ACT scores: $13 \%$ | Number submitting SAT scores: 1825 <br> Number submitting ACT scores: 268 |  |
| :-- | :-- | :-- |
|  | 25th percentile | 75 th percentile |
| SAT I Verbal | 410 | 530 |
| SAT I Math | 440 | 570 |
| ACT Composite | 16 | 21 |
| ACT English | 14 | 21 |
| ACT Math | 16 | 23 |
...
Percent who had GPA of 3.0 and higher: $60 \%$
Percent who had GPA between 2.0 and 2.9: $39.4 \%$
...
|  |  | Admitted <br> applicants | Enrolled <br> applicants |
| :-- | :-- | :-- | :-- |
| Men | $\mathbf{4 4 0 0}$ | $\mathbf{2 5 0 0}$ | $\mathbf{1 8 9 4}$ |
| Women | $\mathbf{4 8 1 9}$ | $\mathbf{2 7 1 8}$ | $\mathbf{2 0 6 4}$ |
| Total | $\mathbf{9 2 1 9}$ | $\mathbf{5 2 1 8}$ | $\mathbf{3 9 5 8}$ |
...
D12. Report the lowest grade earned for any course that may be transferred for credit: N/A
...
E4. Books, serial backfiles, and government documents (titles) that are accessible through the library's catalog include bound periodicals and newspapers and exclude microforms: 1,101,995 (line 25, column 2)
E5. Current serials (titles): - include periodicals, newspapers, and government documents: 2,504 (line 29, column 2)

E6. Microforms (titles): 1,621,426 (line 31, column 2)
E7. Video and audio (titles): 37,146 (sum of lines 36 and 38, column 2)
# San José State University 
...
| :-- | :-- | :-- |
| Percent who are from out of state (exclude internat'l/nonresident <br> aliens) | $\mathbf{1 . 8 \%}$ | $\mathbf{0 . 8 \%}$ |
| Percent of men who join fraternities |  |  |
| Percent of women who join sororities |  |  |
| Percent who live in college-owned, -operated, or -affiliated <br> housing |  | $\mathbf{1 0 \%}$ |
| Percent who live off campus or commute |  |  |
| Percent of students age 25 and older | $\mathbf{0 . 3 \%}$ | $\mathbf{3 7 . 2 \%}$ |
| Average age of full-time students | $\mathbf{1 8 . 3}$ | $\mathbf{2 3 . 2}$ |
| Average age of all students (full- and part-time) | $\mathbf{1 8 . 3}$ | $\mathbf{2 4 . 9}$ |
...
| Out-of-state: |  | $\mathbf{7 8 4 3}$ |
| Nonresident Aliens: |  |  |
|  |  |  |
| Required Fees: |  | $\mathbf{1 9 3 9}$ |
|  |  |  |
| Room and Board: (on-campus) |  | $\mathbf{6 2 4 8}$ |
| Room Only: (on-campus) |  |  |
...
| :-- | :-- | :-- | :-- |
| Books and supplies: | $\mathbf{6 4 8}$ | $\mathbf{6 4 8}$ | $\mathbf{6 4 8}$ |
| Room only: | $\mathbf{3 5 5 2}$ |  | $\mathbf{4 5 6 6}$ |
| Board only: | $\mathbf{2 6 9 6}$ |  | $\mathbf{1 7 5 5}$ |
| Transportation: | $\mathbf{5 5 8}$ | $\mathbf{7 0 2}$ | $\mathbf{8 1 0}$ |
| Other expenses: | $\mathbf{1 2 2 4}$ | $\mathbf{1 5 2 7}$ | $\mathbf{1 4 6 2}$ |
...
| In-state (out-of-district): |  |
| Out-of-state: | $\underline{246 \text { per }}$ <br> unit |
| Nonresident Aliens: |  |
# San José State University 
...
H1. Enter total dollar amount awarded in the 1997-98 academic year to full-time and part-time degreeseeking undergraduates (using the same cohort reported in CDS Question B1, "total degree-seeking" undergraduates) in the following categories. Include aid awarded to international students (i.e., those not qualifying for federal aid). Do not include non-need-based athletically related aid or tuition waivers that are personnel benefits.
...
|  | \$ | \#U | \#F | \$ | \#U | \#F |
| Scholarships/Grants |  |  |  |  |  |  |
| Federal | 13,951,984.00 |  |  |  |  |  |
| State | 9,959,164.00 |  |  |  |  |  |
| Other external scholarships/grants administered by college |  |  |  | 1,287,506.00 |  |  |
| Institutional | 186,239.00 |  |  |  |  |  |
| Total Scholarships/Grants | 24,097,387.00 |  |  | 1,287,506.00 |  |  |
| Self-Help |  | 5,795 | 1,088 |  | 357 | 12 |
| Student loans | 16,273,080.00 |  |  | 2,499,722.00 |  |  |
| Federal Work Study | 7,152,103.00 |  |  |  |  |  |
| State and other work |  |  |  |  |  |  |
| study/employment |  |  |  |  |  |  |
| Total Self-Help | 23,425,184.00 |  |  | 2,499,722.00 |  |  |
| Parent Loans |  |  |  |  |  |  |
...
| :--: | :--: | :--: | :--: |
| a) Number of degree-seeking students (CDS Item B1) | 3342 | 13551 | 9378 |
| b) Number of students in line a who were financial aid applicants | 2155 | 7746 | 3043 |
| c) Number of students in line b who were determined to have financial need | 1781 | 6770 | 2372 |
| d) Number of students in line c who received any need-based gift aid | 1574 | 6042 | 1573 |
| e) Number of students in line c who received any need-based self-help aid | 1088 | 4573 | 1222 |
| f) Number of students in line c who received any non-need-based gift aid | 151 | 358 | 65 |
| g) Number of students in line c who received any non-need-based self-help aid | 12 | 272 | 85 |
| h) Number of students in line c whose need was fully met | 263 | 999 | 350 |
| i) On average, the percentage of need that was met of students who received any need-based aid. Exclude any resources that were awarded to replace EFC. | $15 \%$ | $21 \%$ | $19 \%$ |
| j) The average financial aid package of those in line c. Exclude any resources that were awarded to replace EFC. | $\$ 6540.00$ | $\$ 6601.00$ | $\$ 4771.00$ |

H4. Percent of 1997 graduating undergraduate class who have borrowed through all loan programs (federal, state, subsidized, unsubsidized, etc.): $35.5 \%$

H5. Average per-student cumulative undergraduate indebtedness of those in line H4: \$3527.00
