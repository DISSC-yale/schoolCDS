...
| Non-resident aliens <br> IPEDS cols. 1-2 | $\mathbf{1 9 5}$ | $\mathbf{6 7 5}$ |
| Black, non-Hispanic <br> IPEDS cols. 3-4 | $\mathbf{2 2 9}$ | $\mathbf{1 0 6 9}$ |
| American Indian or <br> Alaskan Native <br> IPEDS cols. 5-6 | $\mathbf{2 2}$ | $\mathbf{1 6 3}$ |
| Asian or Pacific <br> Islander <br> IPEDS cols. 7-8 | $\mathbf{1 0 4 8}$ | $\mathbf{6 1 9 6}$ |
| Hispanic <br> IPEDS cols. 9-10 | $\mathbf{6 0 2}$ | $\mathbf{3 2 3 2}$ |
| White, non-Hispanic <br> IPEDS cols. 11-12 | $\mathbf{1 2 5 7}$ | $\mathbf{6 4 4 1}$ |
| Race/ethnicity <br> unknown <br> IPEDS cols. 13-14 | $\mathbf{7 2 2}$ | $\mathbf{3 9 7 7}$ |
| Total <br> IPEDS cols. 15-16 | $\mathbf{4 0 7 5}$ | $\mathbf{2 1 7 5 3}$ |
...
B4. Initial 1994 cohort of first-time, full-time bachelor's (or equivalent) degree-seeking undergraduate students; total all students: 1758
...
B6. Final 1994 cohort, after adjusting for allowable exclusions: 1758
(Subtract question B5 from question B4)
B7. Of the initial 1993 initial cohort, how many completed the program in four years or less (by August 31, 1998): n/a (IPEDS GRS, Section II, Part A, line 19, sum of columns 15 and 16)
B8. Of the initial 1993 cohort, how may completed the program in more than four years but in five years or less (after August 31, 1999 and by August 31, 1998): n/a (IPEDS GRS, Section II, Part A, line 20, sum of columns 15 and 16)
B9. Of the initial 1994 cohort, how many completed the program in more than five years but in six years or less (after August 31, 1999 and by August 31, 2000): 222 (IPEDS GRS, Section II, Part A, line 21, sum of columns 15 and 16)
B10. Total graduating within six years (sum of questions B7, B8, and B9): 680
(IPEDS GRS, Section II, Part A, line 18, sum of
columns 15 and 16)
B11. Six-year graduation rate for 1994 cohort (question B10 divided by question B6): $39 \%$
...
|  |  | Considered <br> Require for if |  |  |
| :--: | :--: | :--: | :--: | :--: |
| SAT I |  | Require | Recommend some | submitted Not used |
| ACT |  |  |  |  |
...
| Percent submitting SAT scores: 85\% <br> Percent submitting ACT scores: 13\% | Number submitting SAT scores: n/a <br> Number submitting ACT scores: n/a |
| :-- | :-- |
|  | 25th percentile 75th percentile |
| SAT I Verbal | 390 530 |
| SAT I Math | 430 560 |
| ACT Composite | 17 23 |
| ACT English | 15 22 |
| ACT Math | 18 24 |
...
Other: No set date by which applicants must accept admission
...
| Men |  |  |  |
| Women |  |  |  |
| Total | $\mathbf{7 1 8 1}$ | $\mathbf{5 6 0 3}$ | $\mathbf{3 3 1 0}$ |
...
D16. Minimum number of credits that transfers must complete at your institution to earn a bachelor's degree: 30 unit: semester
...
| Percent who live off campus or commute |  | $\mathbf{9 3 \%}$ |
| Percent of students age 25 and older | $\mathbf{0 . 5 \%}$ | $\mathbf{3 5 . 3 \%}$ |
| Average age of full-time students | $\mathbf{1 8 . 3}$ | $\mathbf{2 4}$ |
...
$\square$ On campus
$\square$ At cooperating institution (name): $\qquad$ UC Berkeley, $\qquad$
...
| In-state (out-of-district): |  | $\mathrm{n} / \mathrm{a}$ |
| Out-of-state: |  | $\mathbf{7 3 8 0}$ |
| Nonresident Aliens: |  | $\mathrm{n} / \mathrm{a}$ |
|  |  |  |
| Required Fees: |  | $\mathbf{1 9 3 9}$ |
|  |  |  |
| Room and Board: (on-campus) |  | $\mathbf{6 5 7 5}$ |
| Room Only: (on-campus) |  | $\mathrm{n} / \mathrm{a}$ |
| Board Only: (on-campus meal plan) |  | $\mathrm{n} / \mathrm{a}$ |
...
## 11. Please report number of instructional faculty members in each category for Fall 1999.
...
Report the Fall 2000 ratio to full-time equivalent students (full-time plus $1 / 3$ part-time) to full-time equivalent instructional faculty (full-time plus $1 / 3$ part-time). In the ratio calculations, exclude both faculty and students in stand-alone graduate or professional programs such as medicine, law, veterinary, dentistry, social work, business, or public health in which faculty teach virtually only graduate level students. Do not count undergraduate or graduate student teaching assistants as faculty.

Fall 2000 Student to Faculty ratio: 18 to 1.
...
Class Sections: A class section is an organized course offered for credit, identified by discipline and number, meeting at a stated time or times in a classroom or similar setting, and not a subsection such as a laboratory or discussion session. Undergraduate class sections are defined as any sections in which at least one degree-seeing undergraduate student is enrolled for credit. Exclude distance learning classes and noncredit classes and individual instruction such as dissertation or thesis research, music instruction, or one-toone readings. Exclude students in independent study, co-operative programs, internships, foreign language taped tutor sessions, practicums, and all students in one-on-one classes. Each class section should be counted only once and should not be duplicated because of source catalog cross-listings.
...
Note: Items preceded by an asterisk $\left({ }^{*}\right)$ represent definitions agree to among publishers which do not appear on the CDS document but may be present on individual publisher's surveys.
...
secondary school divided by the number of courses taken. The most common system of assigning numbers to grades counts four points for an A , three points for a B , two points for a C , one point for a D , and no points for an E or F. Unweighted GPA's assign the same weight to each course. Weighting gives students additional points for their grades in advanced or honors courses.
