...
B3. Number of degrees awarded by your institution from July 1, 2016 to June 30, 2017. (As of October 9, 2017)

| Certificate/diploma |  |
| :-- | :--: |
| Associate degrees | 288 |
| Bachelor's degrees | 4,068 |
| Postbachelor's certificates | 1,017 |
| Master's degrees |  |
| Post-master's certificates | 254 |
| Doctoral degrees - research/scholarship | 56 |
...
Please provide data for the Fall 2011 cohort if available. If Fall 2011 cohort data are not available, provide data for the Fall 2010 cohort. (Data provided for Fall 2010 and Fall 2011 cohorts)
...
| :--: | :--: | :--: | :--: | :--: |
| A - Initial 2010 cohort of first-time, fulltime, bachelor's (or equivalent) degreeseeking undergraduate students | 398 | 829 | 2,138 | $\begin{aligned} & 3,365 \\ & \text { (formerly B4) } \end{aligned}$ |
...
| C - Final 2010 cohort, after adjusting for allowable exclusions | 398 | 829 | 2,138 | $\begin{aligned} & 3,365 \\ & \text { (formerly B6) } \end{aligned}$ |
| D - Of the initial 2010 cohort, how many completed the program in four years or less (by Aug. 31, 2014) | 230 | 596 | 1,573 | $\begin{aligned} & 2,399 \\ & \text { (formerly B7) } \end{aligned}$ |
| E - Of the initial 2010 cohort, how many completed the program in more than four years but in five years or less (after Aug. 31, 2014 and by Aug. 31, 2015) | 51 | 71 | 210 | $\begin{aligned} & 332 \\ & \text { (formerly B8) } \end{aligned}$ |
| F - Of the initial 2010 cohort, how many completed the program in more than five years but in six years or less (after Aug. 31, 2015 and by Aug. 31, 2016) | 13 | 8 | 38 | $\begin{aligned} & 59 \\ & \text { (formerly B9) } \end{aligned}$ |
| G - Total graduating within six years (sum of lines D, E, and F) | 294 | 675 | 1,821 | $\begin{aligned} & 2,790 \\ & \text { (formerly B10) } \end{aligned}$ |
| H - Six-year graduation rate for 2010 cohort (G divided by C) | $73.9 \%$ | $81.4 \%$ | $85.2 \%$ | $\begin{gathered} 82.9 \% \\ \text { (formerly B11) } \end{gathered}$ |
# Common Data Set: University of Delaware (2017-2018) 
...
|  | Recipients of a Federal Pell Grant | Recipients of a Subsidized Stafford Loan who did not receive a Pell Grant | Students who did not receive either a Pell Grant or a subsidized Stafford Loan | Total (sum of 3 columns to the left) |
| :--: | :--: | :--: | :--: | :--: |
| A - Initial 2011 cohort of first-time, fulltime, bachelor's (or equivalent) degreeseeking undergraduate students | 435 | 1,119 | 2,352 | $\begin{gathered} 3,906 \\ \text { (formerly B4) } \end{gathered}$ |
...
| C - Final 2011 cohort, after adjusting for allowable exclusions | 435 | 1,119 | 2,352 | $\begin{gathered} 3,906 \\ \text { (formerly B6) } \end{gathered}$ |
| D - Of the initial 2011 cohort, how many completed the program in four years or less (by Aug. 31, 2015) | 269 | 806 | 1,762 | $\begin{gathered} 2,837 \\ \text { (formerly B7) } \end{gathered}$ |
| E - Of the initial 2011 cohort, how many completed the program in more than four years but in five years or less (after Aug. 31, 2015 and by Aug. 31, 2016) | 52 | 78 | 230 | $\begin{gathered} 360 \\ \text { (formerly B8) } \end{gathered}$ |
| F - Of the initial 2011 cohort, how many completed the program in more than five years but in six years or less (after Aug. 31, 2016 and by Aug. 31, 2017) | 12 | 12 | 28 | $\begin{gathered} 52 \\ \text { (formerly B9) } \end{gathered}$ |
| G - Total graduating within six years (sum of lines D, E, and F) | 333 | 896 | 2,020 | $\begin{gathered} 3,249 \\ \text { (formerly B10) } \end{gathered}$ |
| H - Six-year graduation rate for 2011 cohort (G divided by C) | $76.5 \%$ | $80.1 \%$ | $85.9 \%$ | $\begin{gathered} 83.2 \% \\ \text { (formerly B11) } \end{gathered}$ |
# Common Data Set: University of Delaware (2017-2018) 
...
Percent of total first-time, first-year (freshman) students who submitted high school class rank: $\qquad$ $41 \%$
...
The typical tuition, required fees, and room and board for a full-time undergraduate student for the FULL 2017-2018 academic year ( 30 semester hours or 45 quarter hours for institutions that derive annual tuition by multiplying credit hour cost by number of credits) are listed below. A full academic year refers to the period of time generally extending from September to June; usually equated to two semesters, two trimesters, three quarters, or the period covered by a four-onefour plan. Room and board is defined as double occupancy and 19 meals per week or the maximum meal plan. Required fees include only charges that all full-time students must pay that are not included in tuition (e.g., registration, health, or activity fees.) Do not include optional fees (e.g., parking, laboratory use).
...
* 2017 undergraduate class who graduated between July 1, 2016 and June 30, 2017 who started at your institution as first-time students and received a bachelor's degree between July 1, 2016 and June 30, 2017.
...
Total dollar amount of institutional financial aid awarded to undergraduate degree-seeking nonresident aliens: \$ 1,231,457
...
Fall 2017 Student to Faculty ratio: $\qquad$ 13 to 1 (based on Newark Campus undergraduate students and faculty).
